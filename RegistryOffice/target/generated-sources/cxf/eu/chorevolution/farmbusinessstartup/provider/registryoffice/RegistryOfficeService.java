...
public class RegistryOfficeService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/HP/Desktop/Chor/workspaceProject/RegistryOffice/src/main/resources/RegistryOffice.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(RegistryOfficeService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/HP/Desktop/Chor/workspaceProject/RegistryOffice/src/main/resources/RegistryOffice.wsdl");
        }
        WSDL_LOCATION = url;
    }
